...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Omnistack({ baseURL: 'http://localhost:5000/custom/path/', apiKey: 'My API Key' });
    ...
    afterEach(() => {
      process.env['OMNISTACK_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Omnistack({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['OMNISTACK_BASE_URL'] = 'https://example.com/from_env';
      const client = new Omnistack({ apiKey: 'My API Key' });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Omnistack({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Omnistack({ apiKey: 'My API Key' });
    expect(client2.maxRetries).toEqual(2);
  });

  test('with environment variable arguments', () => {
    // set options via env var
    process.env['OMNISTACK_API_KEY'] = 'My API Key';
    const client = new Omnistack();
  ...
  test('with overriden environment variable arguments', () => {
    // set options via env var
    process.env['OMNISTACK_API_KEY'] = 'another My API Key';
    const client = new Omnistack({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Omnistack({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Omnistack({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Omnistack({ apiKey: 'My API Key', fetch: testFetch });
