...
export class VectorStores extends APIResource {
   ...
   */
  create(body: VectorStoreCreateParams, options?: Core.RequestOptions): Core.APIPromise<VectorStoreObject> {
...
export interface VectorStoreCreateParams {
   ...
   */
  chunking_strategy?:
    | VectorStoreCreateParams.AutoChunkingStrategyRequestParam
    | VectorStoreCreateParams.StaticChunkingStrategyRequestParam;
